        ...
        <div className="min-h-screen bg-cream flex items-center justify-center px-4">
            <div className="w-full max-w-[400px] animate-fade-in-up">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-[13px] text-muted mt-1">Sign in to plan your next adventure</p>
                </div>

                {/* Card */}
                <div className="bg-warm border border-border rounded-2xl p-7 shadow-sm">
                    <h2 className="font-display text-[22px] font-semibold text-text-primary mb-5">Welcome back</h2>
